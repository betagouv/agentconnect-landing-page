...
exports.offres_fi_test = [
  {
    title: "E-Campus",
    description:
      "Plateforme de formation professionnelle pour les agents du Ministère de l'Intérieur",
  },
  {
    title: "SPOTE",
    description:
      "Plateforme numérique collaborative des offres numériques de l'État",
  },
];
...
exports.offres_fs_agents = [
  ...
  {
    title:
      "Institut National de la Statistique et des Etudes Economiques (MEFSIN)",
    url: "https://www.insee.fr/fr/accueil",
  },
  {
    title: "Direction générale des Finances publiques (MEFSIN)",
    url: "https://www.economie.gouv.fr/dgfip",
  },
  {
    title: "Direction générale des Douanes et Droits indirects (MEFSIN)",
    url: "https://www.douane.gouv.fr/",
  },
  {
    title: "Direction interministérielle du numérique (MEFSIN)",
